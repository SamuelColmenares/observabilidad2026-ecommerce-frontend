...
import { MetricsManager, TelemetryManager } from "./telemetry/Telemetry";
...
export const metricsManager = new MetricsManager({
  url: "http://172.26.190.162:3005/v1/metrics", // url is optional and can be omitted - default is http://localhost:4318/v1/traces
  headers: {}, // an optional object containing custom headers to be sent with each request
  concurrencyLimit: 10, // an optional limit on pending requests
});

export const shoppingCarVisitsMetric = metricsManager.createCounter(
  "numero de visitas a carrito de compra",
);
